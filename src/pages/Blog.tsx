...
const Blog = () => {
  const posts = [
    ...
    },
    {
      ...
      excerpt:
        "Afro Nation Portugal, Davido & Friends Fest, Burna Boy, Wizkid and more — your complete guide to every confirmed Afrobeats event this summer. Real dates, real prices.",
      date: "March 24, 2026",
