    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "15px" }}>
          {/* Instagram */}
          <a
            href="https://www.instagram.com/celestifan_official?igsh=dWQ3b205ZDJ6bWNl&utm_source=qr"
            target="_blank"
          ...
          {/* Twitter (X) */}
          <a
            href="https://x.com/celestifan_off?s=21"
            target="_blank"
            rel="noopener noreferrer"
            style={iconStyle}
...
const hoverStyle = {
  background: "rgba(178, 210, 52, 0.3)",
  transform: "scale(1.1)",
};
